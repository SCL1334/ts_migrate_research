...
// processInput(123); // 這行程式碼將無法通過編譯

console.log("\n結論：");
console.log("在 'noImplicitAny: true' 的設定下，編譯器在開發階段就強制我們處理了型別問題。");
console.log("這避免了在執行時期才出現的錯誤，大大提高了程式碼的可靠性。");
console.log("這證明了，唯有啟用 noImplicitAny，TypeScript 的型別遷移才算真正完成。");
