...
console.log('單價 100，無數量參數:', calculateTotalPriceTraditional(100, undefined));     // quantity 會是 1
console.log('單價 100，數量 5:', calculateTotalPriceTraditional(100, 5));     // quantity 會是 5
console.log('單價 100，數量 0 (副作用):', calculateTotalPriceTraditional(100, 0)); // 這裡會是 100 * 1，因為 0 被 || 運算子轉成了 false
console.log('\n');
